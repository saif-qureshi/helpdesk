/**
 * Real brand SVG logos for integrations. Single-color marks (Jira, Linear,
 * HubSpot, GitHub) use official Simple Icons paths; Slack uses its official
 * 4-color mark; Segment is an approximated arc mark. GitHub uses currentColor
